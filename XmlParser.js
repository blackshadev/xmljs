module.exports = (function() {
    ...
    var parser = $o.Object.extend({
        ...
        _createEvents: function() {
            ...
            this.saxParser.onerror = function(err) {
                ...
                if (self.continueOnError) self.saxParser.resume();
            };
        },
    ...
    parser.isXmlNode = function(n) {
        return n instanceof XmlNode;
    };
    ...
    var Node = $o.Object.extend({
        ...
        addNode: function(n) {
            if (!this.children[n.localName]) this.children[n.localName] = [];
        ...
        path: function(arr, ignoreCase) {
            ...
            function next_caseinvar(parNode, left) {
                ...
                arr.forEach(function(n) {
                    next_caseinvar(n, left.slice(1));
                });
            }

            if (ignoreCase) next_caseinvar(this, arr);
            else next(this, arr);
            return nodes;
        },
        visit: function(fn) {
            fn(this);
            for (var k in this.children) this.children[k].visit(fn);
        }
    });
